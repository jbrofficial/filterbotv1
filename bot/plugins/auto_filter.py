...
async def auto_filter(bot, update):
    ...
    if filters:
        #results.append(
        #        [
        #            InlineKeyboardButton("🏅 OUR CHANNEL 🏅", url="https://t.me/crazy_rockers")
        #        ]
        #    ) 
    ...
    if len(results) == 0: # double check
        ...
        ibuttonss.append(
                        [
                            InlineKeyboardButton("⭕️ REQUEST GROUP 📥⭕️", url="https://t.me/CCREQUEST")
                        ]
                    )
        for x in ibuttonss:
                result[0].insert(0, x) #Insert invite link buttons at first of page
